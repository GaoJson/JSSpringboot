...
public class Tools {
   ...
   public static List<Object> getProductData(ProductDao productDao){
       ...
       params.put("pageNum", Collections.singletonList(1));
       params.put("pageSize",Collections.singletonList(100));

       String url = "https://api.yuehaigj.com/api/"+"goods/v1/good";
       HttpEntity<MultiValueMap<String, Integer>> httpEntity = new HttpEntity<>(params, headers);
       ...
       for (int i = 0; i < rows.size(); i++) {
           ...
           product.setProduct_name(model.get("goodsName").toString());
           product.setProduct_banner(model.get("goodsBanner").toString());
           product.setProduct_content(model.get("goodsContent").toString());
           product.setProduct_img(model.get("goodsImg").toString());
           product.setProduct_id(Integer.parseInt(model.get("id").toString()));
           product.setProduct_price(Double.parseDouble(model.get("originalPrice").toString()));
           product.setProduct_sale_price(Double.parseDouble(model.get("goodsPrice").toString()));
           Integer aa = productDao.addProduct(product);
       }
